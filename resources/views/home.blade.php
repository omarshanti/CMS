			...
			<div class="fh5co-menu">
				<div class="fh5co-box">
					...
					<ul>
						...
						<li><a href="{{route('posts')}}">Show Posts</a></li>
						<li><a href="{{route('deleted.posts')}}">Deleted Posts</a></li>
						<li><a href="{{route('category.create')}}">Create Category</a></li>
						<li><a href="{{route('category')}}">Category Info</a></li>
						<li><a href="{{route('tag.create')}}">Create Tag</a></li>
						<li><a href="{{route('tag')}}">Tag Info</a></li>
					</ul>
				</div>
				<div class="fh5co-box">
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 text-center">
						<h1 id="fh5co-logo"><a href="/">SHANTI <sup>TM</sup></a></h1>
					</div>
